...
namespace HRProject.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("EmployeeId,FirstName,LastName,Gender,DateOfBirth,DateOfEmployment,PhoneNumber,Email,Address1,Address2,City,State,Zip")] Employee employee)
        {
